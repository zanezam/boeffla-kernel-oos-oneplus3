...
KERNEL_SPECS="oneplus3t;oos;oos4xx;http://kernel.boeffla.de/oneplus3t/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS4xx-OnePlus3T-anykernel.recovery.zip"
