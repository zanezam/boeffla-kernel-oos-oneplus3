...
KERNEL_SPECS="oneplus3;oos;oos4xx;http://kernel.boeffla.de/oneplus3/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS4xx-OnePlus3-anykernel.recovery.zip"
