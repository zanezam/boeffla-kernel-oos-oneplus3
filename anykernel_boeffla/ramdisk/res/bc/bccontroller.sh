...
KERNEL_SPECS="oneplus3;oos;oos3xx;http://kernel.boeffla.de/oneplus3/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS3xx-OnePlus3-anykernel.recovery.zip"
